...
export function RequiredReading() {
  const documents = [
    { title: "Synthetic Voice Technology Framework Agreement", ref: "DG-SVTF-2026/0001/A", size: "2.4 MB", pages: 147 },
    { title: "EU AI Act Compliance Guidelines for Voice Synthesis", ref: "DG-AICG-2026/0012/B", size: "1.8 MB", pages: 89 },
    { title: "Data Protection Impact Assessment Template", ref: "DG-DPIA-2026/0023/C", size: "892 KB", pages: 34 },
    { title: "Accessibility Standards for Synthetic Audio (WCAG 2.1 AAA)", ref: "DG-ACCS-2026/0034/D", size: "1.2 MB", pages: 56 },
    { title: "Terms of Service and Acceptable Use Policy", ref: "DG-TAUP-2026/0045/E", size: "3.1 MB", pages: 203 },
    { title: "Technical Integration Manual (API v2.3.1)", ref: "DG-TIMA-2026/0056/F", size: "4.7 MB", pages: 312 },
    { title: "Incident Reporting and Escalation Procedures", ref: "DG-IREP-2026/0067/G", size: "756 KB", pages: 28 },
    { title: "Annual Compliance Certification Requirements", ref: "DG-ACCR-2026/0078/H", size: "1.5 MB", pages: 67 },
  ];
  ...
  const handleDownload = (e: React.MouseEvent, docRef: string) => {
    ...
    setTimeout(() => {
      alert(`Document ${docRef} download initiated.\n\nNote: Document will be watermarked with your session ID for tracking purposes per DG-TRACK-2026/0044/W.`)
    }, 300)
  }
  ...
  return (
    <div className="gov-section">
      ...
      <div className="ref-number">[Ref: DG-MAND-2026/0099/I]</div>
      ...
      <div className="eu-yellow-box">
        ...
        <p className="text-xs mt-1">
          ...
          Failure to comply may result in application rejection under Article 14(3) of Regulation 2026/1873.
        </p>
      </div>
      ...
      <div className="mt-4 pt-4 border-t border-gray-300">
        <p className="text-xs text-gray-600">
          <sup>1</sup> Reading time calculation methodology defined in Annex IV of Document DG-METH-2026/0088/X<br/>
          <sup>2</sup> Average reading speed derived from EU-wide literacy assessment study (N=47,892*, 2019)
        </p>
      </div>
      <SectionDownload sectionRef="DG-MAND-2026/0099/I" />
    </div>
  );
}
